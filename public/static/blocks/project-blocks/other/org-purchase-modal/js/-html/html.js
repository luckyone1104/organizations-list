  ...
  shipping: `
    <div class="payment-modal__shipping-details shipping-details"">
      <div class="shipping-details__left-column">
        <img class="shipping-details__left-image" src="/static/blocks/project-blocks/other/org-purchase-modal/images/truck.svg" alt="">
      </div>
        ...
        <div class="payment-details__credit-card credit-card">
          <div class="credit-card__first-row">
            <div class="credit-card__payment-system-logo">
              <img class="master-card-logo" style="display:none;"  src="/static/blocks/project-blocks/other/org-purchase-modal/images/master-card-logo.svg" alt="">
              <img class="visa-logo" src="/static/blocks/project-blocks/other/org-purchase-modal/images/visa-logo.svg" alt="">
            </div>
          </div>

          <div class="credit-card__second-row">
            <div class="credit-card__bank-chip-image">
              <img class="card-chip" src="/static/blocks/project-blocks/other/org-purchase-modal/images/credit-card-chip.svg" alt="">
            </div>
          </div>
  ...
  confirmation:`
    <div class="payment-modal__confirmation-page confirmation-page">
      <div class="confirmation-page__left-column">
        <img class="confirmation-page__left-image" src="/static/blocks/project-blocks/other/org-purchase-modal/images/confirmation.svg" alt="">
      </div>
