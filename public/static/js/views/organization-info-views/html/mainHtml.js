export default {
    ...
    <div class="organization-info_unlocked">
      <div class="organization-info__card-section card-section">
        ...
        <div class="card-section__text">
          <span>Отослать одному или всем клиентам уведомления</span>
        </div>
      </div>
      ...
      <div class="organization-info__card-section card-section">
        ...
        <div class="card-section__text">
          <span>Поверить карту клиента по номеру или имени</span>
        </div>
      </div>
      ...
      <div class="organization-info__card-section card-section">
        ...
        <div class="card-section__text">
          <span>Посмотреть шаблоны ваших карт</span>
        </div>
      </div>
      ...
      <div class="organization-info__card-section card-section">
        ...
        <div class="card-section__text">
          <span>Посмотреть данные ваших клиентов</span>
        </div>
      </div>
    </div>
  `,
  ...
  <div class="organization-info_locked">
    ...
    <p>Организация не оплачена, чтобы перейти к оплате, нажмите кнопку ниже</p>

    <button class="organization-info__button green-button btn btn-success">
      Оплатить организацию
    </button>
  </div>
  `,
}